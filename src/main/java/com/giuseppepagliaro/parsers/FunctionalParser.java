...
/**
 * Functional Implementation of {@link com.giuseppepagliaro.parsers.Parser}.
 * @author Giuseppe Pagliaro
 * @version 1.1.0
 * @since 1.0.0
 */
public class FunctionalParser implements Parser {
    public FunctionalParser(String problem, ProblemOperator[] operators, boolean acceptParenthesis) throws IncorrectProblemSyntaxException {
    ...
    public FunctionalParser(String problem) throws IncorrectProblemSyntaxException {
